  ...
  render() {
    return (
      ...
      >
        ...
        <video
          id="heroVideo"
          className="hero-video position-absolute"
          width="100%"
          height="600px"
          preLoad="none"
          muted
        ...
        <div className="row text-white justify-content-center align-items-center hero-section">
          <div className="col-lg-8 col-md-8 col-sm-8">
            <div className="row">
              <div className="col">
                <h1 className="hero-text-header text-center">
                  Welcome to Nolan Softworks
                </h1>
              </div>
            </div>
            <div className="row">
              <div className="col">
                <h4 className="hero-text-body text-center">
                  Website Design, Application Development, and much more!
                </h4>
              </div>
            </div>
          </div>
        ...
        <div className="row py-0 py-lg-4">
          <div className="col-lg-4 col-md-4 col-sm-12 py-3 py-lg-0 text-center">
            ...
            <Link
              to="/request-quote"
              className="btn btn-primary text-white rounded-pill px-4 btn-full-width-mobile"
            >
              Request Quote
            </Link>
          </div>
        ...
        <div className="row justify-content-center website-background py-5">
          <div className="col-xl-5 col-lg-8 col-md-12 col-sm-12 text-center text-white">
            <h3 className="font-weight-bold border-bottom border-white pb-1">
              Websites
            </h3>
            ...
            <p className="p-0 m-0">Custom Website</p>
            <p className="p-0 m-0">Website Management</p>
            <Link
              to="/services#websites"
              className="btn btn-outline-light rounded-pill px-4 outline-light-text mt-2 btn-full-width-mobile"
            >
              View Details
            </Link>
          </div>
        ...
        <div className="row justify-content-center application-background py-5 text-white">
          <div className="col-xl-5 col-lg-8 col-md-12 col-sm-12 text-center">
            ...
            <h5>
              Desktop & Web Applications built for personal or business use
            </h5>
            <div className="row justify-content-center">
              <div className="px-4">
        ...
        <div className="row justify-content-center mobile-app-background py-5 text-white">
          <div className="col-xl-5 col-lg-8 col-md-12 col-sm-12 text-center">
            ...
            <p className="p-0 m-0">Application Management</p>
            <Link
              to="/services#mobileApplications"
              className="btn btn-outline-light rounded-pill px-4 outline-light-text mt-2 btn-full-width-mobile"
            >
              View Details
            </Link>
