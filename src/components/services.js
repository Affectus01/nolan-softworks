                    ...
                    <div className="col-lg-12">
                        <div id="websites" className="row p-5 align-items-center">
                            ...
                            <div className="col-lg-6">
                                ...
                                <Link to="/request-quote" className="btn btn-primary rounded-pill px-4">Submit Quote</Link>
                            </div>
                        </div>
                        ...
                        <div id="mobileApplications" className="row p-5 align-items-center mb-4">
                            <div className="col-lg-6">
